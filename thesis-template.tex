...
\end{itemize}
Whenever a grade is submitted, the backend recomputes the FSRS memory variables, persists them to the relational database, and schedules the exact timestamp for the next review.
